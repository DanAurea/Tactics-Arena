...
#define NB_MAX_DECOR 7 /**< Nombre max d'unité par joueur */
...
typedef struct{unitName name; unitStat stat; vector unitTarget[MAX_RANGE]; unitEffect effect[NB_MAX_EFFECT];short direct; short noPlayer;}unit; /**< */
